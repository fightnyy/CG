...
function createCubePosColor(sx, sy, sz) {
    var tmpvertex = [
        // -(0.5)*sx, 0.5*sy, -0.5*sz, 1.0, 0.0, 1.0, 1.0, //a
        // -0.5*sx, -0.5*sy, -0.5*sz,1.0, 1.0, 1.0, 1.0,   //b
        // 0.5 *sx, -0.5*sy, -0.5*sz, 1.0, 0.0, 1.0, 1.0, //c
        // 0.5*sx, 0.5*sy, -0.5*sz, 1.0, 0.5, 1.0, 1.0, //d
        // -0.5 *sx, 0.5*sy, 0.5*sz,0.5, 0.2, 1.0, 1.0, //e
        // -0.5*sx, -0.5*sy, 0.5*sz,0.5, 0.2, 1.0, 1.0, //f
        // 0.5, -0.5, 0.5, 0.7, 0.2, 0.6, 1.0,//g
        // 0.5,0.5,0.5,0.2,0.5,0.7,1.0,//h



        0.93*sx, -0.93*sy, 0.8*sz, 1, 1, 1, 1.0, //g
        -0.93*sx, -0.93*sy, 0.8*sz, 1, 1, 1, 1.0, //f
        0.93*sx, 0.93*sy, 0.8*sz, 1, 1, 1, 1.0, //h 

        //tri hef                                               /*back */ //white
        -0.93*sx, -0.93*sy, 0.8*sz, 1, 1, 1, 1.0, // First Triangle //f
        -0.93*sx, 0.93*sy, 0.8*sz, 1, 1, 1, 1.0, //e
        0.93*sx, 0.93*sy, 0.8*sz, 1, 1, 1, 1.0, //h
        ...
        -0.93 * sx, 0.93* sy, 0.8 * sz, 0.0, 1.0, 0.0, 1.0, //e

                                                                    /*left*/ //green
        //tri bfe
        -0.5 * sx, -0.5 * sy, -0.5 * sz, 0.0, 1.0, 0.0, 1.0, //b
        -0.93 * sx, -0.93 * sy, 0.8 * sz, 0.0, 1.0, 0.0, 1.0, //f
        -0.93 * sx, 0.93* sy, 0.8 * sz, 0.0, 1.0, 0.0, 1.0, //e
        ...
        0.93*sx, 0.93*sy, 0.8*sz, 0.0, 0.0, 1.0, 1.0, //h
                                                                    /*right*/ //blue
        //tri cgh
        0.5 * sx, -0.5 * sy, -0.5 * sz, 0.0, 0.0, 1.0, 1.0, //c
        0.93*sx, -0.93*sy, 0.8*sz, 0.0, 0.0, 1.0, 1.0, //g
        0.93*sx, 0.93*sy, 0.8*sz, 0.0, 0.0, 1.0, 1.0, //h
        ...
        -0.93 * sx, 0.93 * sy, 0.8 * sz, 1.0, 1.0, 0.0, 1.0, //e
        0.93*sx, 0.93*sy, 0.8*sz, 1.0, 1.0, 0.0, 1.0, //h
                                                                    /*up*/ //yellow
        //tri adh
        -(0.5) * sx, 0.5 * sy, -0.5 * sz, 1.0, 1.0, 0.0, 1.0, //a
        ...
        -0.93 * sx, -0.93 * sy, 0.8 * sz, 0.0, 1.0, 1.0, 1.0, //f
        0.93*sx, -0.93*sy, 0.8*sz, 0.0, 1.0, 1.0, 1.0, //g
                                                                    /*down*///cyan
        //tri bcg
        -0.5 * sx, -0.5 * sy, -0.5 * sz, 0.0, 1.0, 1.0, 1.0, //b
...
function initialiseShaders() {
    ...
    gl.useProgram(gl.programObject); //메모리에 로딩하고 실행할 준비하고 있는거
